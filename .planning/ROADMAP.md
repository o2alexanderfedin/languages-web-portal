...
Plans:
- [x] 09-01-PLAN.md — Activate Java Verification tool (status, description, availability, timeout)
- [x] 09-02-PLAN.md — Create three Java example projects with tests
- [ ] 09-03-PLAN.md — Add example selector UI to frontend (gap closure)
